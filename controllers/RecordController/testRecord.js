...
const {
  Field,
} = require("@zohocrm/nodejs-sdk-2.0/core/com/zoho/crm/api/record/field");
...
class Record {
  ...
  static async createRecords() {
     ...
     * 2 -> Value
     */
    record.addFieldValue(RecordField.Leads.LAST_NAME, "Norris");

    record.addFieldValue(RecordField.Leads.FIRST_NAME, "Kevin");

    record.addFieldValue(RecordField.Leads.COMPANY, "APPLE");

    record.addFieldValue(RecordField.Leads.CITY, "City");
    record.addFieldValue(RecordField.Leads.STATE, "Great");

    record.addFieldValue(RecordField.Leads.PHONE, "5555555");

    record.addFieldValue(RecordField.Leads.MOBILE, "5555555");

    record.addFieldValue(RecordField.Leads.WEBSITE, "https://zoho.com");

    record.addFieldValue(RecordField.Leads.DESCRIPTION, "Great Team player");

    record.addFieldValue(
      RecordField.Leads.SKYPE_ID,
      "live:.cid.341246e7f2030592"
    );

    record.addFieldValue(RecordField.Leads.STREET, "Lomza Podlasie");
    record.addFieldValue(RecordField.Leads.FAX, "asdf sfdsf");
    record.addFieldValue(RecordField.Leads.ZIP_CODE, "2423423");
    record.addFieldValue(new Field("Twitter"), "TwiterURL");
    record.addFieldValue(new Field("Title"), "Title");
    // record.addFieldValue(RecordField.Leads.TWITTER, "sdfsdsdf");
    record.addFieldValue(
      RecordField.Leads.SECONDARY_EMAIL,
      "smartfullstack@gmail.com"
    );

    // record.addFieldValue(RecordField.Leads.RATING, "4");
    record.addFieldValue(RecordField.Leads.LEAD_SOURCE, new Choice("Hey Call"));
     ...
     * 2 -> Value
     */
    record.addKeyValue("Title", "Valuesdfsdf");
